...
export function RoomCanvas({ roomId }: { roomId: number }) {
  ...
  return (
    <div className="relative w-screen h-screen">
      ...
      {isMenuOpen && (
        <div className={`fixed px-2 py-4 ml-4 ${isThemeDark ? "bg-[#23232a] text-2xl text-white" : "bg-[#ffffff] text-black"} rounded-md top-20 z-10 w-54 h-[30vh] overflow-y-auto [&::-webkit-scrollbar]:w-0.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-500 [&::-webkit-scrollbar-thumb]:rounded-full`}>
          ...
          {/* <div className="pt-4">
            <SocialLink
              ...
              href="https://github.com/ankit_kxt/drawception"
            />
           */}
          {/* </div> */}
        </div>
